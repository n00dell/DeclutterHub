...
namespace DeclutterHub.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,IsSold,CreatedAt,Location,phoneNumber,IsNegotiable,Condition,CategoryId,UserId")] Item item)
        {
